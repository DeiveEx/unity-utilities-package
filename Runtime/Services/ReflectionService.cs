...
namespace DeiveEx.Utilities
{
	public class ReflectionService
	{
		...
		public IEnumerable<Type> GetAllChildTypes(Type baseType, Assembly targetAssembly = null)
		{
		...
		public IDictionary<string, object> GetAllFieldsValues<T>(T target, BindingFlags flags = BindingFlags.Instance | BindingFlags.Public)
		{
			var type = typeof(T);

...
{
    public static void FillArea(Tilemap tilemap, IEnumerable<Vector3Int> positions, TileBase tile)
    {
    ...
    public static bool IsAreaFree(Tilemap tilemap, Vector3Int start, int regionSize)
    {
